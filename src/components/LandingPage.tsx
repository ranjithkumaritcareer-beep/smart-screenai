          ...
          <section className="space-y-6 my-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              ...
              >
                ...
                {/* Prominent Glow Button */}
                <div className="mt-5 inline-flex items-center justify-between w-full px-4 py-2.5 rounded-xl bg-gradient-to-r from-brand-cyan to-blue-500 text-slate-950 font-bold font-mono text-xs uppercase tracking-wider shadow-[0_0_20px_rgba(0,242,254,0.4)] group-hover:shadow-[0_0_30px_rgba(0,242,254,0.6)] transition-all">
              ...
              >
                ...
                {/* Prominent Glow Button */}
                <div className="mt-5 inline-flex items-center justify-between w-full px-4 py-2.5 rounded-xl bg-gradient-to-r from-brand-purple to-indigo-500 text-white font-bold font-mono text-xs uppercase tracking-wider shadow-[0_0_20px_rgba(139,92,246,0.4)] group-hover:shadow-[0_0_30px_rgba(139,92,246,0.6)] transition-all">
